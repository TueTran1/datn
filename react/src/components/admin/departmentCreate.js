...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <nav class="  navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
        <p class=" h3 mb-0 text-gray-800 text-center" >Create New Department Page</p>
       
        </nav>

        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a class="h5 mb-0 text-gray-800" href="/company-details"><u>Back</u></a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-7">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form class="user" onSubmit={this.handleSubmit}>
                                        ...
                                        <input   type="text" class=" " placeholder="Department Name"
